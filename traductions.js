...
window.TRAD = {
  en: {
    ...
    "indispo.": "n/a",
    "TTK au corps selon la distance, d'après les paliers de dégâts réels (codmunity). Plus bas = plus rapide.": "Body TTK by distance, from real damage brackets (codmunity). Lower = faster.",
    "balle": "shot",
    "balles": "shots",
    "cadence": "rate",
    "c/min": "rpm",
  ...
  de: {
    ...
    "indispo.": "k.A.",
    "TTK au corps selon la distance, d'après les paliers de dégâts réels (codmunity). Plus bas = plus rapide.": "Körper-TTK nach Distanz, aus echten Schadensbereichen (codmunity). Niedriger = schneller.",
    "balle": "Schuss",
    "balles": "Schüsse",
    "cadence": "Feuerrate",
    "c/min": "S/min",
